export const head =
` $contrl coord=unique units=angs dfttyp=b3lyp runtyp=eda ispher=1
exetyp=run maxit=200 icharg=0 mult=1  scftyp=rhf $end
 $scf npunch=2 dirscf=.t. $end
 $lmoeda matom(1)=2 matom(2)=10 matom(3)=16 mcharg(1)=1 mcharg(2)=0 mcharg(3)=-1 mmult(1)=1 mmult(2)=1 mmult(3)=1  supbas=.t.
 $end
 $system mwords=2500 $end
